...
print ("El conteo de registros por la categoría de bibliotecas es:", len(cant_reg_mus))
...
print ("El conteo de registros por la categoría de bibliotecas es:", len(cant_reg_biblio))
...
print ("El conteo de registros por la categoría de bibliotecas es:", len(cant_reg_cines))
